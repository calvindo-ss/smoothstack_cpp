...
constexpr Customers::Customers(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : account_(){}
struct CustomersDefaultTypeInternal {
  constexpr CustomersDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~CustomersDefaultTypeInternal() {}
  union {
    Customers _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT CustomersDefaultTypeInternal _Customers_default_instance_;
}  // namespace bankcli
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_users_2eproto[2];
...
const uint32_t TableStruct_users_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, accountnum_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, username_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, password_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, fname_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, lname_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, ssn_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, balance_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, dateopened_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, accounttype_),
  PROTOBUF_FIELD_OFFSET(::bankcli::Account, admin_),
  5,
  0,
  1,
  2,
  ...
  9,
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::bankcli::Customers, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::bankcli::Customers, account_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 16, -1, sizeof(::bankcli::Account)},
  { 26, -1, -1, sizeof(::bankcli::Customers)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::bankcli::_Account_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::bankcli::_Customers_default_instance_),
};

const char descriptor_table_protodef_users_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013users.proto\022\007bankcli\"\341\002\n\007Account\022\027\n\nac"
  "countNum\030\001 \001(\005H\000\210\001\001\022\025\n\010username\030\002 \001(\tH\001\210"
  "\001\001\022\025\n\010password\030\003 \001(\tH\002\210\001\001\022\022\n\005fname\030\004 \001(\t"
  "H\003\210\001\001\022\022\n\005lname\030\005 \001(\tH\004\210\001\001\022\020\n\003ssn\030\006 \001(\005H\005"
  "\210\001\001\022\024\n\007balance\030\007 \001(\001H\006\210\001\001\022\027\n\ndateopened\030"
  "\010 \001(\tH\007\210\001\001\022\030\n\013accounttype\030\t \001(\005H\010\210\001\001\022\022\n\005"
  "admin\030\n \001(\005H\t\210\001\001B\r\n\013_accountNumB\013\n\t_user"
  "nameB\013\n\t_passwordB\010\n\006_fnameB\010\n\006_lnameB\006\n"
  "\004_ssnB\n\n\010_balanceB\r\n\013_dateopenedB\016\n\014_acc"
  "ounttypeB\010\n\006_admin\".\n\tCustomers\022!\n\007accou"
  "nt\030\001 \003(\0132\020.bankcli.Accountb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_users_2eproto = {
  false, false, 434, descriptor_table_protodef_users_2eproto, "users.proto", 
  &descriptor_table_users_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_users_2eproto::offsets,
  file_level_metadata_users_2eproto, file_level_enum_descriptors_users_2eproto, file_level_service_descriptors_users_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_users_2eproto_getter() {
  return &descriptor_table_users_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_users_2eproto(&descriptor_table_users_2eproto);
namespace bankcli {
...
// @@protoc_insertion_point(message_clear_start:bankcli.Account)
  ...
  if (cached_has_bits & 0x000000e0u) {
    ::memset(&accountnum_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&accountnum_)) + sizeof(balance_));
  }
  if (cached_has_bits & 0x00000300u) {
    ::memset(&accounttype_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&admin_) -
        reinterpret_cast<char*>(&accounttype_)) + sizeof(admin_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "bankcli.Account.username"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "bankcli.Account.password"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "bankcli.Account.fname"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "bankcli.Account.lname"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          _Internal::set_has_ssn(&has_bits);
          ssn_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 66)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "bankcli.Account.dateopened"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Account::_InternalSerialize(
  ...
  if (_internal_has_ssn()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(6, this->_internal_ssn(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:bankcli.Account)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_ssn());
    }
...
class Customers::_Internal {
 public:
};

Customers::Customers(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  account_(arena) {
  SharedCtor();
  ...
  // @@protoc_insertion_point(arena_constructor:bankcli.Customers)
}
Customers::Customers(const Customers& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      account_(from.account_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:bankcli.Customers)
}

inline void Customers::SharedCtor() {
}

Customers::~Customers() {
  // @@protoc_insertion_point(destructor:bankcli.Customers)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void Customers::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void Customers::ArenaDtor(void* object) {
  Customers* _this = reinterpret_cast< Customers* >(object);
  (void)_this;
}
void Customers::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void Customers::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void Customers::Clear() {
// @@protoc_insertion_point(message_clear_start:bankcli.Customers)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* Customers::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
uint8_t* Customers::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:bankcli.Customers)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:bankcli.Customers)
  return target;
}

size_t Customers::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:bankcli.Customers)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData Customers::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    Customers::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*Customers::GetClassData() const { return &_class_data_; }

void Customers::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Customers *>(to)->MergeFrom(
      static_cast<const Customers &>(from));
}


void Customers::MergeFrom(const Customers& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:bankcli.Customers)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void Customers::CopyFrom(const Customers& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:bankcli.Customers)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Customers::IsInitialized() const {
  return true;
}

void Customers::InternalSwap(Customers* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  account_.InternalSwap(&other->account_);
}

::PROTOBUF_NAMESPACE_ID::Metadata Customers::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_users_2eproto_getter, &descriptor_table_users_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::bankcli::Customers* Arena::CreateMaybeMessage< ::bankcli::Customers >(Arena* arena) {
  return Arena::CreateMessageInternal< ::bankcli::Customers >(arena);
}
